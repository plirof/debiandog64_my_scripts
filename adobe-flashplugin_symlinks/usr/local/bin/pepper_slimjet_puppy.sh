...
su - puppy -c "/usr/bin/flashpeak-slimjet --user-data-dir=/mnt/sda1/downloads_linux/.data/slim --disk-cache-dir=/mnt/sda1/downloads_linux/.cache/slim --ppapi-flash-path=/usr/lib/adobe-flashplugin/libpepflashplayer.so --ppapi-flash-version=24.0.0.221"
