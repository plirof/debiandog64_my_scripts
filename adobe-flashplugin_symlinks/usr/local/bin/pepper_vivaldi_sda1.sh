...
su - puppy -c "vivaldi-stable --ppapi-flash-path=/usr/lib/adobe-flashplugin/libpepflashplayer.so --ppapi-flash-version=24.0.0.221  --user-data-dir=/mnt/sda1/downloads_linux/.data/viva --disk-cache-dir=/mnt/sda1/downloads_linux/.cache/viva"
